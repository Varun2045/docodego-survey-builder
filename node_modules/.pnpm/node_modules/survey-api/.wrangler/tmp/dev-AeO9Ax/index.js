...
// .wrangler/tmp/bundle-egUvup/checked-fetch.js
...
// ../node_modules/.pnpm/hono@4.12.25/node_modules/hono/dist/utils/encode.js
...
// ../node_modules/.pnpm/hono@4.12.25/node_modules/hono/dist/utils/jwt/jwa.js
...
// ../node_modules/.pnpm/hono@4.12.25/node_modules/hono/dist/helper/adapter/index.js
var knownUserAgents = {
  deno: "Deno",
  bun: "Bun",
...
// ../node_modules/.pnpm/hono@4.12.25/node_modules/hono/dist/utils/jwt/types.js
...
// ../node_modules/.pnpm/hono@4.12.25/node_modules/hono/dist/utils/jwt/utf8.js
var utf8Encoder = new TextEncoder();
var utf8Decoder = new TextDecoder();

// ../node_modules/.pnpm/hono@4.12.25/node_modules/hono/dist/utils/jwt/jws.js
...
// ../node_modules/.pnpm/hono@4.12.25/node_modules/hono/dist/utils/jwt/jwt.js
...
// ../node_modules/.pnpm/hono@4.12.25/node_modules/hono/dist/utils/jwt/index.js
var Jwt = { sign, verify, decode, verifyWithJwks };

// ../node_modules/.pnpm/hono@4.12.25/node_modules/hono/dist/middleware/jwt/jwt.js
...
var app = new Hono2();
app.use("*", cors());
var JWT_SECRET = "super-secret-key-change-me-in-production";
...
async function verifyPassword(password, storedHash) {
  ...
  const match2 = saltHex.match(/.{1,2}/g);
  if (!match2) return false;
  const salt = new Uint8Array(match2.map((byte) => Number.parseInt(byte, 16)));
  const encoder = new TextEncoder();
  const passwordKey = await crypto.subtle.importKey(
    "raw",
    encoder.encode(password),
  ...
  const hashHexToVerify = Array.from(new Uint8Array(derivedBits)).map((b) => b.toString(16).padStart(2, "0")).join("");
...
app.use("/api/surveys/*", async (c, next) => {
  ...
  const isPublicSurveyDetails = method === "GET" && /^\/api\/surveys\/[^\/]+$/.test(path);
  const isPublicResponseSubmit = method === "POST" && /^\/api\/surveys\/[^\/]+\/responses$/.test(path);
...
app.post("/api/surveys", async (c) => {
  ...
  try {
    ...
    const newSurvey = {
      ...
      bg_style: "tinted",
      created_at: (/* @__PURE__ */ new Date()).toISOString()
      // D1 will write CURRENT_TIMESTAMP, but return matches type
    };
...
app.put("/api/surveys/:id", async (c) => {
  ...
  try {
    ...
    const { title, primary_color, logo_url, is_open, font_family, bg_style } = body;
    const newTitle = title !== void 0 && title !== null ? title.trim() : currentSurvey.title;
    const newColor = primary_color !== void 0 && primary_color !== null ? primary_color.trim() : primary_color === null ? null : currentSurvey.primary_color;
    const newLogo = logo_url !== void 0 && logo_url !== null ? logo_url.trim() : logo_url === null ? null : currentSurvey.logo_url;
    const newIsOpen = is_open !== void 0 && is_open !== null ? is_open : currentSurvey.is_open;
    const newFont = font_family !== void 0 && font_family !== null ? font_family.trim() : currentSurvey.font_family;
    const newBgStyle = bg_style !== void 0 && bg_style !== null ? bg_style.trim() : currentSurvey.bg_style;
    if (!newTitle) {
...
app.put("/api/surveys/:id/questions", async (c) => {
  ...
  try {
    ...
    for (const q of questions) {
      ...
      const stringifiedLogic = q.logic_rule ? JSON.stringify(q.logic_rule) : null;
      statements.push(
        c.env.DB.prepare(
...
app.post("/api/surveys/:id/responses", async (c) => {
  ...
  try {
    ...
    ).bind(id, surveyId, stringifiedAnswers).run();
...
app.post("/api/upload", authMiddleware, async (c) => {
  if (!c.env.BUCKET) {
    return c.json(
      {
        error: "R2 storage is disabled. Please upload logos using the local Base64 uploader."
      },
      501
    );
  }
...
// ../node_modules/.pnpm/wrangler@4.100.0_@cloudflare+workers-types@4.20260613.1/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../node_modules/.pnpm/wrangler@4.100.0_@cloudflare+workers-types@4.20260613.1/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-egUvup/middleware-insertion-facade.js
...
// ../node_modules/.pnpm/wrangler@4.100.0_@cloudflare+workers-types@4.20260613.1/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-egUvup/middleware-loader.entry.ts
